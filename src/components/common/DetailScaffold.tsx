  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: palette.paper }} edges={["top"]}>
      ...
      <View style={[styles.header, { borderBottomColor: palette.line }]}>
        <MotionPressable onPress={goBack} style={[styles.back, { backgroundColor: palette.white, borderColor: palette.line }]} accessibilityLabel="이전 화면으로 돌아가기"><Text style={{ color: palette.ink, fontSize: 27 }}>‹</Text></MotionPressable>
